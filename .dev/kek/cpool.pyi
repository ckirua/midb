"""Type stubs for the Cython-optimized asyncpg pool wrapper."""
...
_current_pool: ContextVar[Optional["CPool"]]
...
class CPool:
    ...
    @classmethod
    def get(cls, name: str) -> "CPool": ...
    @classmethod
    def set_current(cls, pool: "CPool") -> None: ...
    @classmethod
    def current(cls) -> "CPool": ...
    async def _create_pool(self) -> AsyncpgPool: ...
    async def initialize(self) -> None: ...
    async def close(self) -> None: ...
    async def __aenter__(self) -> "CPool": ...
    async def __aexit__(
        self,
...
# Helper function
async def cconnection() -> asyncpg.Connection: ...
